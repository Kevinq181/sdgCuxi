...
export const Horarios = () => {
  ...
  let mensaje = String(curr);
  let arr = mensaje.split(" ");
  let horario = arr[4].split(":");

  return (
    <>
      <div className="contenedor">
        <div className="centro">
          <h3 className="tittle1">Actividades extra-horario </h3>
          <div className="form">
            <form className="formulario" onSubmit={createReports}>
              <div className="form-group">
                ...
                >
                  ...
                  <option value={"Kevin Quito"}>Kevin Quito</option>
                  <option value={"Nancy Alvarado"}>Nancy Alvarado</option>
                </select>
              </div>
              <div className="form-group">
              ...
              <div className="form-group">
                <label className="prioridad">
                  <FontAwesomeIcon icon={faClock} /> Hora de inicio
                </label>
                <input
                  type="time"
                  id="hora_inicio"
                  ...
                  min="07:00"
                  max="23:00"
                  defaultValue={horario[0] + ":" + horario[1]}
                  required
                  disabled
                ></input>
              </div>
              <div className="form-group1">
                <button
                  ...
                  onClick={() => [
                    setFecha(date),
                    setHora_inicio(horario[0] + ":" + horario[1]),
                  ]}
                >
                  ENVIAR
                </button>
